      ...
      <div className={styles.pageContent}>
        ...
        <div>
          ...
          <div className={styles.rightcontents}>
            ...
            >
              <div className={filesubmit ? styles.activemulti : styles.inactivemulti}>File</div>
              <div className={!filesubmit ? styles.activemulti : styles.inactivemulti}>Text</div>
            </button>
          </div>
        ...
        <h1 className="body-bold">Preview</h1>
        {filesubmit ? (
          file && (
